...
<a href="/choose-meals"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
  Select a meal
...
<section class="flex flex-row items-center justify-between border border-zinc-950 w-5/12 my-2 pl-8">
  ...
  <button type="submit" on:click={addDinner}>Set My Meal</button>
  <add-to-calendar-button
  label='Add a meal'
    name={config.name}
    options='Google'
...
<section class="flex flex-row items-center justify-between border border-zinc-950 w-5/12 my-2 pl-8">
  ...
  <button type="submit" on:click={addExtras}>Set My Meal</button>
  <add-to-calendar-button
  label='Add a meal'
    name={config.name}
    options='Google'
